...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="Libros.jsp">Libros</a></li>
      ...
      <div>
          <br>
        <a href="guardar.jsp" class="btn btn-primary">AGREGAR LIBRO</a>
          <br>
          <br>
          <form method="post" action="Libros.jsp">
          ...
          <table class="table table-striped">
                ...
                if (request.getParameter("buscar") != null) {
                    if (request.getParameter("buscar").isEmpty()) {
                        con.setConsulta("select * from libros where estado='activo'");
                    } else {
                        
                        con.setConsulta("select * from libros where nombre like '%"+ nom +"%' and estado='activo'");
                    }
                }else{
                    con.setConsulta("select * from libros where estado='activo'");
                }
            %>
                    <%
                       con.setConsulta("select * from libros where libros.autor_id=libros.autor_id AND libros.estado='activo'");
                       while(con.getResultado().next()){
                        out.println("<tr>");
                           ...
                           out.println("<td>"+"<a href='editar.jsp?editar="+con.getResultado().getString("libro_id")+"' class='btn btn-success'>EDITAR</a>"+"</td>");
